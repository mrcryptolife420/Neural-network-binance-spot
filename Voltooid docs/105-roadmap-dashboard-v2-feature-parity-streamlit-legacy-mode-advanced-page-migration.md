...
```text
Dashboard V2 MVP
â†’ page parity matrix
â†’ critical workflow migration
â†’ advanced page migration
â†’ realtime chart/state optimization
â†’ Streamlit legacy fallback
â†’ browser smoke + UAT acceptance
â†’ Dashboard V2 recommended mode
```
...
* \[ ] Operator docs/UAT scenarioâ€™s bevatten Dashboard V2.
...
* Het maakt vervolg-PRâ€™s veel gerichter.
...
* [x] Dashboard V2 parity safety contract.
* [x] Page parity matrix vanuit `ui.page_registry.PAGES`.
* [x] Backward-compatible `dashboard_v2_page_parity()` payload.
* [x] Streamlit legacy/fallback status en dashboard-choice command.
* [x] Dashboard V2 browser smoke matrix.
* [x] Dashboard V2 performance budget report.
* [x] React navigation shell, sidebar, legacy badge en route placeholders.
* [x] Chart reducer/limit helpers.
* [x] Dashboard V2 parity/performance/legacy CLI commands.
* [x] Check-all integratie voor Dashboard V2 page parity.
* [x] Dashboard V2 docs en operator migration docs.

Belangrijke bestanden:

* `src/binance_spot_bot/dashboard_v2/page_parity.py`
* `src/binance_spot_bot/dashboard_v2/legacy.py`
* `src/binance_spot_bot/dashboard_v2/performance.py`
* `src/binance_spot_bot/dashboard_v2/browser_smoke.py`
* `src/binance_spot_bot/dashboard_v2/smoke.py`
* `src/binance_spot_bot/dashboard_v2_parity.py`
* `dashboard-v2/src/components/AppShell.tsx`
* `dashboard-v2/src/components/Sidebar.tsx`
* `dashboard-v2/src/components/LegacyBadge.tsx`
* `dashboard-v2/src/pages/OverviewPage.tsx`
* `dashboard-v2/src/pages/LegacyPlaceholderPage.tsx`
* `dashboard-v2/src/charts/useChartData.ts`
* `tests/test_roadmap_105_dashboard_v2_parity_acceptance.py`

Validatie:

* [x] `python -m pytest tests/test_roadmap_105_dashboard_v2_parity_acceptance.py tests/test_roadmaps_104_122_full_surface.py::test_105_109_dashboard_v2_parity_deprecation_and_extension_surfaces -q` -> 5 passed.
* [x] Dashboard V2 parity/legacy/performance CLI command flow uitgevoerd.
* [x] `python -m pytest tests/test_roadmaps_104_122_full_surface.py tests/test_roadmap_104_dashboard_v2_acceptance.py tests/test_roadmap_105_dashboard_v2_parity_acceptance.py -q` -> 18 passed.
* [x] `python -m binance_spot_bot.cli check-all --skip-tests --json` -> ok.
* [x] `python -m binance_spot_bot.cli dashboard-smoke --seconds 1` -> ok.
* [x] `python -m pytest -q` -> 397 passed, 1 warning.

Safety-resultaat:

* [x] Page parity blokkeert live pages.
* [x] Streamlit blijft fallback zonder extra live capabilities.
* [x] Browser smoke matrix valideert no-live banner per critical route.
* [x] Performance en parity reports bevatten `live_trading_enabled=False`.
