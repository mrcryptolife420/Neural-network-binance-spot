...
* [x] Paper OS stabilization safety contract.
* [x] Roadmap 100 audit ingestor.
* [x] Stabilization backlog en priority mapping.
* [x] Blocker classifier.
* [x] Stabilization workplan generator.
* [x] Check reliability tracker.
* [x] Flaky check burn-down.
* [x] Slow check hardening.
* [x] Dashboard smoke stabilizer.
* [x] Paper simulation stabilizer.
* [x] Evidence gap detector.
* [x] Secret-free evidence verification.
* [x] Waiver systeem met P0-block.
* [x] Stabilization gate.
* [x] Stabilization report.
* [x] Stabilization evidence bundle.
* [x] CLI commands voor de volledige stabilisatieflow.
* [x] Dashboard panel update.

Belangrijke bestanden:

* `src/binance_spot_bot/stabilization_audit_ingest.py`
* `src/binance_spot_bot/stabilization_backlog.py`
* `src/binance_spot_bot/stabilization_classifier.py`
* `src/binance_spot_bot/stabilization_workplan.py`
* `src/binance_spot_bot/check_reliability.py`
* `src/binance_spot_bot/flaky_check_burndown.py`
* `src/binance_spot_bot/slow_check_hardening.py`
* `src/binance_spot_bot/dashboard_smoke_stabilizer.py`
* `src/binance_spot_bot/paper_simulation_stabilizer.py`
* `src/binance_spot_bot/evidence_gap_detector.py`
* `src/binance_spot_bot/stabilization_secret_verify.py`
* `src/binance_spot_bot/stabilization_waivers.py`
* `src/binance_spot_bot/stabilization_gate.py`
* `src/binance_spot_bot/stabilization_report.py`
* `src/binance_spot_bot/stabilization_evidence_bundle.py`
* `tests/test_roadmap_101_stabilization_acceptance.py`

Validatie:

* [x] `python -m pytest tests/test_roadmap_101_stabilization_acceptance.py tests/test_roadmaps_097_102_full_surface.py::test_101_stabilization_gate_burns_down_unwaived_blockers -q` -> 6 passed.
* [x] `python -m pytest tests/test_roadmaps_097_102_full_surface.py tests/test_roadmap_100_paper_os_milestone_acceptance.py tests/test_roadmap_101_stabilization_acceptance.py tests/test_roadmaps_076_102_paper_os.py -q` -> 21 passed.
* [x] Roadmap 101 CLI command flow uitgevoerd.
* [x] `python -m binance_spot_bot.cli check-all --skip-tests --json` -> ok.
* [x] `python -m binance_spot_bot.cli dashboard-smoke --seconds 1` -> ok.
* [x] `python -m pytest -q` -> 383 passed, 1 warning.

Safety-resultaat:

* [x] Live trading blijft disabled.
* [x] P0 no-live/security findings zijn niet waivebaar.
* [x] Secret-like stabilization evidence blokkeert verificatie.
* [x] Stabilization gate kan niet passeren met open P0/P1 blockers.
