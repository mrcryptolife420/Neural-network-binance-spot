# Pilot Acceptance 1778863453964-d584894c

- Final acceptance: resume_required
- Mode: demo
- Symbol: BTCUSDT
- Status: stopped
- Stop final state: resume_required
- Orders: 2
- Alerts: 3
- Runner status: -
- Runner id: -
...
| clean_start | fail | needs_operator_action | Reconcile/cancel before start | True |
| no_open_orders | fail | 1 open orders | Cancel or reconcile open orders | True |
| runtime_idle | pass | running | Stop current runtime | True |
| Clean start | fail | needs_operator_action | Resolve dashboard checklist blocker | True |
| No orphan orders | fail | 1 orphan orders | Resolve dashboard checklist blocker | True |
