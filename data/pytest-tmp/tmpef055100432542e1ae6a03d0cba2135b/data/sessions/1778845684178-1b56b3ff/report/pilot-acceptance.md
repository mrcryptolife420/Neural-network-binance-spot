# Pilot Acceptance 1778845684178-1b56b3ff
...
- Runner id: runner-1778845684194
...
| Test order | idle | - | - | - |
| Demo order | idle | - | - | - |
| Reconciliation | ok | 1778845684196 | ok | 0 |
| Fill/Cancel/Reject | ok | - | ok | ok |

## Runner
| runner_id | pid | status | last_tick_ms | last_command |
| --- | --- | --- | --- | --- |
| runner-1778845684194 | 48356 | completed | 1778845684238 |  |
